...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ok_btn.setGeometry(QtCore.QRect(600, 40, 93, 28))
    ...
    def ok(self):
        self.emit(QtCore.SIGNAL("fermeturetextwindow(PyQt_PyObject)"), self.lineEdit.text())
